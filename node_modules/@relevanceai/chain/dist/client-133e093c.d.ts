...
type ParamSchema<T> = JSONSchema4 & ParamSchemaMetadata;
...
type TypedJsonSchema<T> = ParamSchema<T> & {
    $tsType: T;
};
type ZodLike<T> = {
    parse: (input: any) => T;
...
type ParamDefinitionInput = Record<string, TypedJsonSchema<any> | ParamSchema<any> | ZodLike<any>>;
type ParamsToTypedObject<T extends ParamDefinitionInput> = {
    [K in keyof T]: T[K] extends ZodLike<infer U> ? U : T[K] extends TypedJsonSchema<infer U> ? U : any;
};
/**
...
type InferChainOutput<Chain extends ChainRunnable> = UnwrapVariable<Awaited<ReturnType<Chain["run"]>>["output"]>;
...
export { AllowedTransformationId as A, ChainConfig as C, InferChainInput as I, JsCodeTransformationOutput as J, Prettify as P, RunChainOptions as R, SchemaMetadata as S, TypedJsonSchema as T, UnwrapVariable as U, Variable as V, RunChainOutput as a, ParamSchema as b, ParamSchemaMetadata as c, ParamDefinitionInput as d, ParamsToTypedObject as e, TransformationInput as f, TransformationOutput as g, ArrayItem as h, ChainState as i, InferChainOutput as j, TransformationsMap as k, CustomTransformationsMap as l, Client as m, RunChainError as n };
